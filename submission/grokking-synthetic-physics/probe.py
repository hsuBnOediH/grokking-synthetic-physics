...
# Tier C = latent dynamics (angular_velocity, init_ang_vel — invisible from
#         a single frame) plus camera pose (cam_azimuth, cam_elevation —
#         visible but not part of the physics task)
GT_VARS = [
    ("gravity",          "gravity",              "B"),
    ("damping",          "damping",              "B"),
    ("length",           "length",               "A"),
