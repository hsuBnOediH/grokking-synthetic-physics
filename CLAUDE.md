...
- **`pendulum_data_v3.h5`** — 14 GB HDF5, 600K frames, 6000 episodes (IID=3200, Near-OOD=1600, Far-OOD=1200)
- **Download**: [pendulum_data_v3.zip (Google Drive)](https://drive.google.com/file/d/1N4rixKHdS5GHfcp3i2OJQLXT5G6GgZrd/view?usp=sharing)
- Also needs: `episode_design.csv` (in repo root — generated by `design_episodes.py`, also checked in)
